...
void setup() {
  ...
  Dxl.begin(3);
  Dxl.wheelMode(ID1); //wheelMode() is to use wheel mode
  Dxl.wheelMode(ID2); //wheelMode() is to use wheel mode
}

void loop() {
  Dxl.goalSpeed(ID1, 500); //forward
  Dxl.goalSpeed(ID2, 1000); //forward
}
